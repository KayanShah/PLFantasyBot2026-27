  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    .pitch {
      ...
      overflow:hidden;
      background:
        linear-gradient(90deg, transparent 49.72%, var(--pitch-line) 49.84%, var(--pitch-line) 50.16%, transparent 50.28%),
        repeating-linear-gradient(90deg, rgba(255,255,255,.065) 0 88px, rgba(255,255,255,.018) 88px 176px),
    ...
    .penalty { position:absolute; left:50%; transform:translateX(-50%); width:315px; height:94px; border:2px solid var(--pitch-line); z-index:0; }
    .penalty.top { top:28px; border-top:0; }
    .penalty.bottom { bottom:28px; border-bottom:0; }
    .goal { position:absolute; left:50%; transform:translateX(-50%); width:122px; height:24px; border:2px solid var(--pitch-line); z-index:0; }
    .goal.top { top:28px; border-top:0; }
    .goal.bottom { bottom:28px; border-bottom:0; }
    ...
    .squad {
      ...
      display:grid;
      grid-template-rows: .85fr 1fr 1fr .95fr;
      align-items:center;
      gap: 4px;
    }
  ...
  <main class="app-shell">
    ...
    <section class="main-grid">
      <article class="pitch-panel">
        ...
        <div class="pitch">
          <div class="penalty top"></div><div class="goal top"></div>
          <div class="penalty bottom"></div><div class="goal bottom"></div>
...
<script>
  ...
  function renderCalendarAndCountdown(){
    ...
    el('calendarList').innerHTML = calendar.map(g => {
      ...
      return `<div class="calendar-row ${isCurrent?'active':''}" data-gw="${g.gw}">
